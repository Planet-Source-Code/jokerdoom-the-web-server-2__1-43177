...
ElseIf InStr(1, FileName, ".bmp") > 0 Then
    TextFile = False
    FileType = "image/bmp"
'An example of how to create server side scripting would be
'Elseif Instr(1, FileName, ".php") > 0 Then
    'TextFile = True
    'FileType = "text/html"
    'ParsedFile = True
'Then carry out php functions and stuff
'Using whatever method you want
'I would place the php functions in another module though
Else
